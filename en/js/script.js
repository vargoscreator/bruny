...
function hideBtn() {
  if (modal__form.classList.contains("show")) {
    ...
    logo.innerHTML = `
      ...
      <div class="modal__title">Thank you for your answers <span>to the questions!</span></div>
    `;
...
function handleMediaQuery(e) {
  if (e.matches) {
    feedbackTitle.innerHTML = 'Please leave your <span>contact details:</span>'; 
  } else {
    feedbackTitle.innerHTML = 'Provide your contact information and we will call you back';
  }
}
